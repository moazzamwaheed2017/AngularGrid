...
export declare class DialogSettings {
     ...
     * A string value sets the width in arbitrary units, e.g `50%`
     */
    width?: number | string;
    /**
     * Specifies the minimum width of the Dialog.
     * A numeric value sets the minimum width in pixels.
     * A string value sets the minimum width in arbitrary units, e.g `50%`
     */
    minWidth?: number | string;
    /**
     * Specifies the height of the Dialog.
     * A numeric value sets the height in pixels.
     * A string value sets the height in arbitrary units, e.g `50%`
     */
