import { Component, ComponentFactoryResolver, ContentChild, Directive, ElementRef, EventEmitter, Host, HostBinding, HostListener, Inject, Injectable, Input, NgModule, NgZone, Optional, Output, Renderer2, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, isDevMode } from '@angular/core';
import { animate, state, style, transition, trigger } from '@angular/animations';
import { L10N_PREFIX, LocalizationService } from '@progress/kendo-angular-l10n';
import { Subject, Subscription, merge, of } from 'rxjs';
import { map, switchMap, take, takeUntil, tap } from 'rxjs/operators';
import { DraggableDirective, DraggableModule, isChanged, isDocumentAvailable } from '@progress/kendo-angular-common';
...
var DialogTitleBarComponent = /** @class */ (function () {
    function DialogTitleBarComponent(hostElement) {
