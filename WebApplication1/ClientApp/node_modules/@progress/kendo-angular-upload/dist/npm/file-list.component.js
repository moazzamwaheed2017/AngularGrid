...
var FileListComponent = /** @class */ (function () {
    ...
    FileListComponent.prototype.itemActionHandler = function (key) {
        ...
        if (key === kendo_angular_common_1.Keys.Escape && files[0].state === file_info_1.FileState.Uploading) {
            this.uploadService.cancelFiles(uid);
            this.navigation.focusSelectButton();
            return;
        }
        if (key === kendo_angular_common_1.Keys.Enter && files[0].state === file_info_1.FileState.Failed) {
